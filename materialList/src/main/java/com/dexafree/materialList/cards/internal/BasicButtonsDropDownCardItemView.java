...
public class BasicButtonsDropDownCardItemView extends BaseButtonsDropDownCardItemView<BasicButtonsCard> {
    ...
    public BasicButtonsDropDownCardItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BasicButtonsDropDownCardItemView(Context context, AttributeSet attrs, int defStyle) {
